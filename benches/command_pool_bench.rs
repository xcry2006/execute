...
fn bench_push_pop_single_thread(c: &mut Criterion) {
    c.bench_function("push_pop_single_thread_1k", |b| {
        b.iter(|| {
...
fn bench_push_multi_thread(c: &mut Criterion) {
    c.bench_function("push_multi_thread_8x1k", |b| {
        b.iter(|| {
...
fn bench_execute_true(c: &mut Criterion) {
    c.bench_function("execute_true_100", |b| {
        b.iter(|| {
            let pool = CommandPool::new();
...
fn bench_push_pop_single_thread_seg(c: &mut Criterion) {
    c.bench_function("seg_push_pop_single_thread_1k", |b| {
        b.iter(|| {
...
fn bench_push_multi_thread_seg(c: &mut Criterion) {
    c.bench_function("seg_push_multi_thread_8x1k", |b| {
        b.iter(|| {
